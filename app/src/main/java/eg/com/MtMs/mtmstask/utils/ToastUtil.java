...
public class ToastUtil {
    ...
    public static void showToast(Context context, @StringRes int toast) {
        showToastMessage(context, context.getString(toast), Toast.LENGTH_SHORT);
    }

    public static void showToast(Context context, String toast) {
        showToastMessage(context, toast, Toast.LENGTH_SHORT);
    }
    ...
    public static void showSuccessToast(Context context, @StringRes int toast) {
        showSuccessToastMessage(context, context.getString(toast), Toast.LENGTH_SHORT);
    }

    public static void showSuccessToast(Context context, String toast) {
        showSuccessToastMessage(context, toast, Toast.LENGTH_SHORT);
    }
    ...
    public static void showWarningToast(Context context, @StringRes int toast) {
        showWarningToastMessage(context, context.getString(toast), Toast.LENGTH_SHORT);
    }

    public static void showWarningToast(Context context, String toast) {
        showWarningToastMessage(context, toast, Toast.LENGTH_SHORT);
    }
    ...
    public static void showInfoToast(Context context, @StringRes int toast) {
        showInfoToastMessage(context, context.getString(toast), Toast.LENGTH_SHORT);
    }

    public static void showInfoToast(Context context, String toast) {
        showInfoToastMessage(context, toast, Toast.LENGTH_SHORT);
    }
    ...
    public static void showErrorToast(Context context, @StringRes int toast) {
        showErrorToastMessage(context, context.getString(toast), Toast.LENGTH_SHORT);
    }

    public static void showErrorToast(Context context, String toast) {
        showErrorToastMessage(context, toast, Toast.LENGTH_SHORT);
    }
...
//        Toast.success(context, toast, length).show();
    }
